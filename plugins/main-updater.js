...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/VENGEANCE254/VENGEANCE-XMD /commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your VENGEANCE-XMD bot is already up-to-date!");
        }

        await reply("🚀 Updating VENGEANCE-XMD Bot...");
        ...
        const sourcePath = path.join(extractPath, "VENGEANCE-XMD-main");
